...
class Page{
    ...
    public function show() {
        ...
        $up_page = $up_row > 0 ? '<li><a class="fa fa-chevron-left" href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '';

        //下一页
        $down_row  = $this->nowPage + 1;
        $down_page = ($down_row <= $this->totalPages) ? '<li><a class="fa fa-chevron-right" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li>' : '';
