...
<script>
   AdobeEdge.loadComposition('index1', 'EDGE-1384962', {
    scaleToFit: "none",
    centerStage: "none",
    minW: "0%",
    maxW: "undefined",
...
<!--微信分享start-->
    ...
    <script type="text/javascript">
      function start(){
            ...
            wordpic(nickname,"./user_images/"+time+".jpeg");
      }
         ...
         function wordpic(wz,tp){
           ...
           ctx.fill();
            ...
            img1.onload = function () {
                ctx.drawImage(img1,284,264,imgwd,imghe);
                // alert(5);
