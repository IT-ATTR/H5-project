<?php
    ...
    if(!$_COOKIE['openid']){
            header("location:../../../wx_login2.php?id=10&url=https://www.mrgcgz.com/h5/html/kjqm20190107/index.php");
            die();
    }
 ?>
<!DOCTYPE html>
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?a5d17d10d2d97ba06def39d810a3d375";
